...
export const ChallengesProvider = ({
  ...
  useEffect(() => {
    ...
    setCurrentExperience(rest.currentExperience ?? 0);
    setChallengesCompleted(rest.challengesCompleted ?? 0);
  ...
  }, [level, currentExperience, challengesCompleted, experienceToNextLevel]);
